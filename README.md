...
# Note
There is no point running this a ton before close to the deadline - it will only encourage hackers to create similar system. After initial testing just run it maybe an hour or two before the claim deadline.
